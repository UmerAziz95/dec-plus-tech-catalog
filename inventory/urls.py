...
urlpatterns = [
    ...
    path('crosscode/parts-catalog/suggestions/', views_crosscode.parts_catalog_suggestions_crosscode_view, name='parts_catalog_suggestions_crosscode'),
    ...
    path('crosscode/basket/suggestions/', views_crosscode.basket_suggestions_crosscode_view, name='basket_suggestions_crosscode'),
    ...
    path('crosscode/brand-names/suggestions/', views_crosscode.brand_names_suggestions_crosscode_view, name='brand_names_suggestions_crosscode'),
